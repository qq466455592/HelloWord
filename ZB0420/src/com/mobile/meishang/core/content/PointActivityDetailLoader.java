...
public class PointActivityDetailLoader extends
		HttpRequestLoader<PointActivityDetail> {

	public PointActivityDetailLoader(Context context,
			ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public PointActivityDetail handle(String content) throws ZLNetworkException {
		try {
			JSONObject jsonObject = new JSONObject(content);
			PointActivityDetail object = new PointActivityDetail(jsonObject);
			return object;
