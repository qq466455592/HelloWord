...
public class ChoujiangDetailLoader extends HttpRequestLoader<ChouJiangDetail> {

	public ChoujiangDetailLoader(Context context, ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public ChouJiangDetail handle(String content) throws ZLNetworkException {
		try {
			JSONObject jsonObject = new JSONObject(content);
			ChouJiangDetail register = new ChouJiangDetail(jsonObject);
			return register;
