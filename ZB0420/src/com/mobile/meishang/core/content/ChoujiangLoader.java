...
public class ChoujiangLoader extends HttpRequestLoader<ChouJiang> {

	public ChoujiangLoader(Context context, ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public ChouJiang handle(String content) throws ZLNetworkException {
		try {
			JSONObject jsonObject = new JSONObject(content);
			ChouJiang object = new ChouJiang(jsonObject);
			return object;
