...
public class VersionLoader extends HttpRequestLoader<Version> {

	public VersionLoader(Context context, ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public Version handle(String content) throws ZLNetworkException {
		try {
