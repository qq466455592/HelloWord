...
public class FavoritesDeleteRequest implements
	...
	public FavoritesDeleteRequest(MActivity leShiHuiActivity) {
	...
	public Loader<Head> onCreateLoader(int arg0, Bundle bundle) {
		...
		urlString.append("?op=collect&act=delete");
		DefaultNetworkRequest mHttpRequest = new DefaultNetworkRequest(
				urlString.toString());
		mHttpRequest.addPostParameter("collect_id", bundle.getString("ids"));
		HeadLoader loader = new HeadLoader(
				mLeShiHuiActivity, mHttpRequest);
		loader.setExceptionHandler(mLeShiHuiActivity);
		loader.setIdentit(RequestDistribute.FAVORITES_LIST_DELETE);
		return loader;
	}
	...
	public void onLoadFinished(Loader<Head> arg0,
			Head arg1) {
		if (arg1 != null) {
			mLeShiHuiActivity.updateUI(RequestDistribute.FAVORITES_LIST_DELETE,
					arg1);
		}
	}
